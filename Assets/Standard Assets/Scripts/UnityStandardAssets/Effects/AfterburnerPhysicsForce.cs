	...
	public class AfterburnerPhysicsForce : MonoBehaviour
	{
		...
		private void OnDrawGizmosSelected()
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				Vector3 a = base.transform.TransformDirection(Quaternion.AngleAxis(effectAngle, array2[i]) * Vector3.forward);
				Gizmos.DrawLine(vector, vector + a * m_Sphere.radius * 2f);
			}
		}
	}
}
