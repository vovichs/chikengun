...
public class PhotonTransformViewPositionControl
{
	...
	public Vector3 GetExtrapolatedPositionOffset()
	{
		...
		{
			Quaternion rotation = Quaternion.Euler(0f, m_SynchronizedTurnSpeed * num, 0f);
			result = rotation * (m_SynchronizedSpeed * num);
			break;
		}
		...
		{
			Vector3 a = (m_NetworkPosition - GetOldestStoredNetworkPosition()) * PhotonNetwork.sendRateOnSerialize;
			result = a * num;
			break;
		}
		}
