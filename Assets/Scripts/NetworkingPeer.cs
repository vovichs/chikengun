...
internal class NetworkingPeer : LoadBalancingPeer, IPhotonPeerListener
{
	...
	public void OnOperationResponse(OperationResponse operationResponse)
	{
		...
		case 220:
		{
			...
			{
				UnityEngine.Debug.Log("Best region found in PlayerPrefs. Connecting to: " + bestFromPrefs);
	...
	public void OnEvent(EventData photonEvent)
	{
		...
		case 210:
		{
			...
			if (PhotonNetwork.logLevel >= PhotonLogLevel.Informational)
			{
				UnityEngine.Debug.Log("Ev OwnershipTransfer. ViewID " + array2[0] + " to: " + array2[1] + " Time: " + Environment.TickCount % 1000);
			}
			int viewID = array2[0];
			int num4 = array2[1];
